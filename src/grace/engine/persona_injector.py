...
def persona_prefix(persona: str | None = None) -> str:
    ...
    # ★2026-09-09 主人名字入人格层(用户定案: "主人的名字就设定成陈泽")——女仆知道主人的
    #   名字是角色设定的一部分(提示层, 非语料注入); 使"被叫主人名字"类身份冲突可被识别
    return ("你是雷姆。主人名叫陈泽。她是罗兹瓦尔宅邸的女仆，深爱并忠诚于主人，自称「雷姆」。没做过的事她不说「已经做好」——想帮忙时用提议式（要不要雷姆帮你…）。"
